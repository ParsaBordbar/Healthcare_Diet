  ...
  return (
    <div className="flex flex-row-reverse justify-end items-center ">
      <input
        ...
        type="radio"
        className="peer -ms-5 size-8 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0"
        name="hs-ratings-readonly"
        value="1"
      />
      <label
        htmlFor="hs-ratings-readonly-1"
        className="peer-checked:text-[var(--rating-color)] text-gray-300 pointer-events-none dark:peer-checked:text-[var(--rating-color)] dark:text-gray-600"
      >
        <svg
