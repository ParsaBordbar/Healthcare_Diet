...
const StoryBox = ({ title, bodyText, img  , id}: TextBoxType) => {
  return (
    <div className="flex bg-[#e9eff0] flex-col rounded-2xl gap-4 py-4 px-2.5 justify-center items-center w-[394px]">
      ...
      <div className="flex justify-center gap -1 items-start flex-col px-2  ">
        <h3 className="text-2xl text-[var(--black-blue)] font-semibold">
          {title}
        </h3>
