        ...
        <section className="lg:gird lg:grid-cols-5 lg:justify-start mt-10 flex flex-col justify-center items-start">
            <div className="flex flex-row items-center">
                <div className="bg-[var(--tittle-box)] rounded-e-3xl gap-6 my-4 col-span-3 py-5 ps-4">
                    ...
                    <h2 className="md:text-7xl text-5xl text-white md:ps-24">مشاور   تغذ  </h2>
                </div>
            ...
            <div className="flex justify-center items-center md:mx-28 xl:flex-row flex-col-reverse">
                <div className="flex md:justify-start md:items-start flex-col md:gap-12 justify-center items-center">
                    <div className="xl:me-40 flex mt-8 lg:justify-start lg:items-start text-center xl:text-right ">
                        ...
                        تیم مشاورین تغذیه ما اینجا هستند تا به شما در دستیابی به اهداف سلامتی و تندرستی خود کمک کنند. مشاوران تغذیه ما مشاوران بسیار آموزش دیده و واجد شرایطی هستند که درک عمیقی از علم تغذیه و چگونگی تأثیر آن بر بدن و ذهن شما دارند.
                        </p>
                    </div>
                    <ul className="flex flex-col gap-5 md:scale-100 scale-90 justify-start ">
                        ...
                        icon={LiIcon}
                        className="lg:gap-6"
                        desc="نظارت بر رژییم غذامشاور تغذیه در آکادمی تغذیه و رژیم غذایی"
                        />
                        <ListItems
                        icon={LiIcon}
                        className="lg:gap-6"
                        ...
                        icon={LiIcon}
                        className="lg:gap-6"
                        desc="مشاور در مدیریت وزن، پیشگیری از بیماری های مزمن و تغذیه ورزشی"
                        />
                        <ListItems
                        icon={LiIcon}
                        className="lg:gap-6"
