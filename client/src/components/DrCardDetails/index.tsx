...
function DoctorsCardDetails() {
  return (
    <div className='bg-[var(--black-blue)] text-white font-extrabold text-3xl flex justify-center flex-col  gap-4 p-8 rounded-xl items-center cursor-pointer'>
        <div className='grid grid-cols-4 gap-12 justify-center items-center md:mt-20'>
           <button className='sm:text-sm text-xs border rounded-full p-2' onClick={() => CopyToClipboard("5041721221242507")}>کپی</button>
