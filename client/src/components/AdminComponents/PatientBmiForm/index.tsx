  ...
  return (
    <section className='flex flex-col bg-[var(--milky-white)] py-4 rounded-lg gap-4 shadow-md'>
        <div className='flex justify-between text-[var(--text)] my-3 items-center'>
          <h2 className='flex items-center bg-[var(--new-green)] text-white text-3xl font-semibold rounded-e-full ps-6 pe-10 py-3'>{name}{" "}{lastName}</h2>
          <p className='flex items-center bg-[var(--new-green)] text-lg font-semibold w-fit text-white mx-12 p-2.5 rounded-full'>BMI:{" "} {bmi}</p>
        </div>
        <div className='flex'>
