  ...
  return (
    <Link href={`${url}`}>
            <div className=" flex p-4 py-9 flex-col bg-[var(--milky-white)] rounded-lg relative z-0 shadow-md  w-full h-36">
                ...
                <div className="-top-5 -right-5 rounded-full flex justify-center items-center text-lg w-14 h-14  bg-[var(--new-green)] text-white z-10 shadow-md  shadow-green-300 absolute">
                        {counter}
                </div> 
            </div>
    </Link>
