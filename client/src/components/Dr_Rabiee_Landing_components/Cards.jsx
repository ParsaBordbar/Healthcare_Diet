...
function CardsSection() {
  return (
    <div className="flex flex-col items-center h-screen bg-[#FEFDF9] overflow-auto relative" dir="rtl">
      ...
      <div className="absolute bottom-0 left-0 w-1/4 h-[60px] bg-[#3531F2] text-white p-2 border-t border-white rounded-tr-full flex items-center justify-center font-[YekanBakhBold]">
