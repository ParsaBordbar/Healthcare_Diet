...
function InformationSection() {
  return (
    <section className="relative p-5 bg-[#FEFDF9]">
      <div className="absolute lg:top-20 top-0  right-0 flex items-center xl:w-1/6 md:w-2/6 w-3/6 h-20 bg-[#3531F2] text-white p-2 rounded-l-full border-t border-white rtl">
      ...
      <div className="flex justify-evenly min-[1109px]:gap-0 gap-4 min-[1109px]:flex-row flex-col-reverse items-center  mt-24">
        <article className="min-[1109px]:w-1/3 w-3/3 min-[1109px]:m-0 mx-auto flex flex-col gap-4 rtl">
          <h3 className="md:text-lg text-base text-justify">
          ...
          <ul className="text-justify [&>li]:md:text-base [&>li]:text-sm flex min-[1109px]:w-full w-4/5 mx-auto min-[1109px]:m-0 flex-col gap-2 pl-5">
        ...
        <div className="flex flex-col md:h-[545px] h-[445px] items-center min-[1109px]:w-1/3 w-4/5 ">
          ...
          <section className="flex flex-col mt-4 gap-2 items-center">
            <p className="text-[var(--black-blue)] text-center font-bold">چهارمین کنگره بین المللی و شانزدهمین سراسری تغذیه ی ایران</p>
            <p className="text-[var(--black-blue)] text-center font-bold">اسفند ۱۴۰۲</p>
          </section>
        </div>
