    ...
    <div className="flex justify-center items-center flex-row w-full bg-hero-bg-mobile md:bg-clip-border bg-cover bg-[#FEFDF9] lg:bg-none md:px-8 mt-10">
      <div className="md:grid 2xl:grid-cols-7 xl:grid-cols-5 md:grid-cols-2 grid-cols-1 ps-2 flex flex-col-reverse">
        ...
        <div className="flex flex-col md:flex-row w-full h-full items-end 2xl:col-span-3 xl:col-span-2 col-span-1 justify-start">
          <div className="flex flex-col items-center justify-center lg:text-right text-center p-5 text-[#3A3A97] rtl">
        ...
        <div className="flex justify-center items-center w-full 2xl:col-span-3 col-span-1 xl:col-span-2">
          <div className="lg:w-[661px] xl:h-[561px]  lg:rounded-[170px_0_170px_0] md:rounded-[90px_0_90px_0] rounded-[50px_0_50px_0] shadow-md overflow-hidden flex justify-center items-center lg:h-[461px] md:h-[360px] md:w-[350px] sm:w-[200px] sm:h-[300px] w-[220px] h-[195px]">
            <Image
            src={HeroImg}
            alt="Hero in Box"          
