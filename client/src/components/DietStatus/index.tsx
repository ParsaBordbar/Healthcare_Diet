...
function DietStatus({ phoneNumber, direction }: DietStatusType) {
  ...
  return (
    <div
      className={`flex  ${direction} justify-evenly xl:justify-center gap-3 bg-[var(--secondary-blue)] p-4 rounded-lg text-white`}
    >
      ...
      <div className="flex gap-1 items-center justify-around ">
        ...
        {lastMediterraneanForm?.isChecked ? (
          <p className="">ویزیت شده</p>
        ) : (
          <p className="">ویزیت نشده</p>
        )}
      </div>
    </div>
  );
