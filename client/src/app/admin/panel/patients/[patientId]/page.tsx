  ...
  return (
    <main>
        <section className='flex flex-col gap-2'>            
            ...
            <PatientBmiForm name={bmiData?.name} lastName={bmiData?.lastName} age={bmiData?.age} gender={bmiData?.gender} phoneNumber={params.patientId} bmi={bmiData?.bmi} wight={bmiData?.wight} height={bmiData?.height}/></>: <h2 className='flex justify-center items-center'>Loading</h2>}
