  ...
  return (
    <main>
        <section className='flex flex-col gap-2'>            
            {bmiData?<> <PatientCard name={bmiData.name} lastName={bmiData.lastName} phoneNumber={bmiData.phoneNumber} gender={bmiData.gender}/>
            <h2 className='text-3xl mt-8'>فرم BMI:</h2>
            <PatientBmiForm name={bmiData?.name} lastName={bmiData?.lastName} age={bmiData?.age} gender={bmiData?.gender} phoneNumber={params.patientId} bmi={bmiData?.bmi} weight={bmiData?.weight} height={bmiData?.height}/></>: <h2 className='flex justify-center items-center'>Loading</h2>}
